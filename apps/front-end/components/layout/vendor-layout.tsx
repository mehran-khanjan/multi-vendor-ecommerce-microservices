...
import { LayoutDashboard, Package, BarChart3, DollarSign, Truck, MessageSquare, Settings, Menu, X } from "lucide-react"
      ...
      >
        <div className="p-6 border-b border-zinc-200 dark:border-zinc-800">
          <Link href="/dashboard" className="flex items-center space-x-2 group">
            ...
            <span className="font-bold text-zinc-900 dark:text-zinc-100">Vendor</span>
          </Link>
        </div>
